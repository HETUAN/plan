...
define(['jquery', 'bootstrap', 'moment', 'datetimepicker', 'DateExtend'], function ($, bootstrap, moment, datetimepicker, DateExtend) {
    ...
    // 显示列表，未分分页
    Daily.prototype.DailyListReload = function (index) {
        //
    ...
    Daily.prototype.Pager = function (rows, pageSize, curIdx) {
        ...
        $("#dailyPager li a").each(function () {
            ...
            $(this)[0].onclick = function () {
                ...
                var d = new Daily();
                d.DailyListReload($(this).attr("val"));
            }
        });
                              ...
                              '<div class="modal-dialog">' +
                                  '<div class="modal-content">' +
                                      ...
                                      '<div class="modal-body">' +
                                       ...
                                       '        <div class="col-sm-10">' +
                                       '            <input type="text" class="form-control" id="DailyAddTitle" placeholder="请输入标题">' +
                                       '        </div>' +
                                       '    </div>' +
                                       '    <div class="form-group">' +
                                       '        <label for="DailyAddSummary" class="col-sm-2 control-label">详细说明</label>' +
                                       '        <div class="col-sm-10">' +
                                       '            <textarea class="form-control" id="DailyAddSummary" rows="9"></textarea>' +
                                       '        </div>' +
                                       '    </div>' +
                                       //'    <div class="form-group">' +
