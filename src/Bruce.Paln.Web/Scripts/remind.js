...
define(['jquery', 'DateExtend', 'Plan'], function ($, DateExtend, Plan) {
    ...
    Remind.prototype.Interval = null;
    Remind.prototype.RemindList = [];
    Remind.prototype.audio = document.createElement("audio");
    Remind.prototype.audio.src = "../Scripts/ring.mp3";
    ...
    var RRemind = {
        ...
        Run: function (msg, milliseconds, callback) {
            //播放音乐
            clearInterval(this.Interval);
            this.Interval = setInterval(function () {
                //console.log(arguments);
